...
export function getDomRefs() {
    return {
        ...
        preInterviewTitle: document.getElementById("pre-interview-title"),
        preInterviewDescription: document.getElementById("pre-interview-description"),
        preSkillChips: document.getElementById("pre-skill-chips"),
        preNameError: document.getElementById("pre-name-error"),
